...
function TakeTurnState:enter(params)
    self:attack(self.firstPokemon, self.secondPokemon, self.firstSprite, self.secondSprite, self.firstBar, self
        .secondBar,
        ...
        function()
            ...
            self:attack(self.secondPokemon, self.firstPokemon, self.secondSprite, self.firstSprite, self.secondBar,
                self.firstBar,
            ...
            gStateStack:push(BattleMessageState('Victory!',
                ...
                function()
                    ...
                    Timer.after(1.5, function()
                        ...
                        Timer.tween(0.5, {
                            [self.battleState.playerExpBar] = { value = math.min(self.playerPokemon.currentExp + exp,
                            ...
                            :finish(function()
                                ...
                                if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                                    ...
                                    -- get current stats, corresponding increases and results
                                    local curHP = self.playerPokemon.HP
                                    local curAttack = self.playerPokemon.attack
                                    local curDefense = self.playerPokemon.defense
                                    local curSpeed = self.playerPokemon.speed
                                    local incHP, incAttack, incDefense, incSpeed
                                    incHP, incAttack, incDefense, incSpeed = self.playerPokemon:levelUp()
